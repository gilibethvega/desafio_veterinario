...
class PetHistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pet_history" do
    assert_difference('PetHistory.count') do
      post pet_histories_url, params: { pet_history: { diagnosis: @pet_history.diagnosis, height: @pet_history.height, status: @pet_history.status, weight: @pet_history.weight } }
    end
  ...
  test "should update pet_history" do
    patch pet_history_url(@pet_history), params: { pet_history: { diagnosis: @pet_history.diagnosis, height: @pet_history.height, status: @pet_history.status, weight: @pet_history.weight } }
